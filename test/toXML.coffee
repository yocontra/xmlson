...
describe 'toXML()', ->
  it 'standard', (done) ->
    expected = '<animals type="pets" test="yeah"><dog type="dumb"><name>Rufus</name><breed>labrador</breed></dog><dog><name>Marty</name><breed>whippet</breed></dog><dog/><cat name="Matilda"/></animals>'
    input = 
      animals:
        "@type":"pets"
        "@test":"yeah"
